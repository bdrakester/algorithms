/**
 * The Point class implements an immutable data type for points in the plane.
 * For use on Coursera, Algorithms Part I programming assignment. The class 
 * along with the Constructor, draw and drawTo methods were provided by the
 * course.
 * 
 * @author Brian Drake
 */
